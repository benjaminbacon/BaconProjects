...
#amixer -Dhw:0 cset name='IN3L Volume' 16 
amixer -Dhw:0 cset name='IN3R Volume' 8
#amixer -Dhw:0 cset name='IN3R Volume' 16 

# better THD in normal mode vs lower noise floor in high performance
amixer -Dhw:0 cset name='IN3 High Performance Switch' off 
...
amixer -Dhw:0 cset name='AIF1TX1 Input 1 Volume' 100 
amixer -Dhw:0 cset name='AIF1TX2 Input 1' IN3R
#amixer -Dhw:0 cset name='AIF1TX2 Input 1 Volume' 32 
amixer -Dhw:0 cset name='AIF1TX2 Input 1 Volume' 100 
